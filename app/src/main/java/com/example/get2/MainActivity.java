        ...
        switch(view.getId()){
            case R.id.btnPost:
                if(!validate())
                    ...
                    httpTask.execute("http://ec2-52-78-121-204.ap-northeast-2.compute.amazonaws.com:8000/api/send_data", etName.getText().toString(), etCountry.getText().toString(), etTwitter.getText().toString());
                }
                break;
        }
